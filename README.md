...
当前文档面向 [v1.2.1 发布包](https://github.com/SYandong/LLM-service-manager/releases/tag/v1.2.1)。
...
从同一 [发布页](https://github.com/SYandong/LLM-service-manager/releases/tag/v1.2.1)
