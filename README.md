...
当前文档面向 [v1.1.0 发布包](https://github.com/SYandong/LLM-service-manager/releases/tag/v1.1.0)。
...
从同一 [发布页](https://github.com/SYandong/LLM-service-manager/releases/tag/v1.1.0)
...
```sh
python3 -m venv .venv
.venv/bin/python -m pip install './llmsvc-1.1.0-py3-none-any.whl[tui]'
.venv/bin/llm
```
